	...
	<div class="ha-col">
		...
		<div class="ha-blocks">
			<div class="ha-block-white ha-line-after">
				...
				<a href="https://www.helloasso.com/associations/?utm_source=HA_Widget&utm_medium=Wordpress&utm_campaign=Widget_Wordpress" target="blank" class="ha-btn ha-btn-secondary"><img src="<?= plugin_dir_url(__FILE__); ?>icons/log-out.svg" /> Inscrire mon association</a>
			</div>
			<div class="ha-block-white ha-line-after">
				<div class="ha-steps">
